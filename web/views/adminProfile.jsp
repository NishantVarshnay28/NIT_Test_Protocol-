				...
				<li class="active"><a href="#">Evaluation Report<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-list"></span></a></li>
					...
					<ul class="dropdown-menu forAnimate" role="menu">
						...
						<li><a href="<c:url value='/views/addFaculty.jsp'></c:url>">Faculty</a></li>
                                ...
                                <li ><a href="<c:url value='/views/changePasswordAdmin.jsp'></c:url>">Change Password<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-cog"></span></a></li>
...
<form  class="form-inline" action="<c:url value='/getTestCode'></c:url>">
...
<form class="form-inline" action="showResult">
