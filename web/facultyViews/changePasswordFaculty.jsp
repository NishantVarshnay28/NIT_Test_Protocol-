		...
		<div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
			<ul class="nav navbar-nav">
                            <li class="divider"></li>
                             ...
                             <li class="divider"></li>
				<li><a href="<c:url value='/facultyViews/facultyProfile.jsp'></c:url>">Evaluation Report<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-list"></span></a></li>
...
<form class="form-inline" action="<c:url value='/changeFaculty'></c:url>" method="post">
